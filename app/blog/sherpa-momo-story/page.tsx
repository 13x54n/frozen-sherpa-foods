...
export const metadata: Metadata = {
    title: "The Story Behind Frozen Sherpa Foods | Authentic Himalayan Cuisine Toronto",
    description: "Discover the family story behind Frozen Sherpa Foods. From a Nepal restaurant to modern frozen meals, bringing authentic Sherpa cuisine like momo and riki kur to Toronto.",
    keywords: [
    ...
    openGraph: {
        title: "The Story Behind Frozen Sherpa Foods | Authentic Himalayan Cuisine",
        description: "My family had a restaurant in Nepal, and from a very young age I grew up helping my mom prepare dinner and learning to honor Sherpa dishes. Today, transforming Sherpa cuisine into ready-to-eat frozen meals for busy individuals.",
        images: [heroImage],
        type: "article",
        locale: "en_CA",
    ...
    twitter: {
        ...
        description: "From Himalayan traditions to modern tables. A family story of preserving Sherpa cuisine through ready-to-eat frozen meals in Toronto.",
        images: [heroImage],
        creator: "@frozensherpafoods",
    },
    alternates: {
        canonical: "https://frozensherpafoods.com/blog/our-story",
    },
    robots: {
        index: true,
        follow: true,
                        ...
                        <div className="grid gap-10">
                            <div className="space-y-8">
                                <section aria-labelledby="how-started">
                                    <h2 id="how-started" className="text-xl sm:text-2xl font-semibold text-yellow-300">
                                ...
                                <section aria-labelledby="himalayan-traditions">
                                    <h2 id="himalayan-traditions" className="text-xl sm:text-2xl font-semibold text-yellow-300">
                                        ...
                                        <article className="overflow-hidden transition duration-300 hover:scale-105 border border-white/10 bg-[#0d1118]">
                                            <div className="relative aspect-[4/3]">
                                                <Image
                                                    ...
                                                    alt="Traditional winter Sherpa dish - shyakpa thenduk rildok Himalayan comfort food"
                                                    fill
                                        ...
                                        <article className="overflow-hidden transition duration-300 hover:scale-105 border border-white/10 bg-[#0d1118]">
                                            <div className="relative aspect-[4/3]">
                                                <Image
                                                    ...
                                                    alt="Sherpa New Year khapseys - traditional Himalayan celebration food Nepali festival"
                                                    fill
                                                    className="object-cover"
                                                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                                />
