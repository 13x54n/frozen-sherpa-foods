        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-lg text-base leading-7 text-white/70">
              Soft, juicy Sherpa dumplings filled with chicken, herbs, ginger, garlic,
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-white/65">
                  Chicken, onion, garlic, ginger, coriander, mild spices, flour, and achar.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-white/65">
                  Savory, aromatic, and comforting with a tangy finish from the chutney.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-white/65">
                  Steam until hot, then pair with achar or chili sauce for extra flavor.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-white/65">
                  Family meals, quick dinners, and sharing with friends.
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-white/70">
              Fresh, soft, and filling with a bold homemade achar that lifts every bite.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-white/70">
              Keep frozen until ready to cook. Reheat until steaming hot before serving.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-[#0d1118] p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-white/70">
              Best enjoyed with extra chutney and a side of fresh vegetables.
            </p>
          </div>
        </div>
      </section>
